	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="topNavbar">
			<ul class="nav navbar-nav">
				<li id="c_overview" role="presentation"><a href=<?php echo '"/Contest/Pandect.php?ConID='.$ConID.'"';?>><span
							class="glyphicon glyphicon-home"><span class="font-size-1"> </span>比赛总览</span></a></li>
...
<h1 class="text-center"><?php echo $ConData['Title']?>
	<?php
			if($User_Jurisdicton == JUR_ADMIN && isset($LandUser))
			{
				...
				if($ConData['Show'] == 1)
                {
					echo '<a target="myIframeNull" class="label label-primary" href="/Contest/ContestStatus.php?ConID='.$ConData['ConID'].'">隐藏</a>';
				}
				else
				{
					echo '<a target="myIframeNull" class="label label-info" href="/Contest/ContestStatus.php?ConID='.$ConData['ConID'].'">显示</a>';
				}

				echo '<iframe id="myIframe" name="myIframeNull" style="display:none">改变状态</iframe>';
			}
		?>
</h1>