...
<body>
    ...
    <form enctype="multipart/form-data" name="upload_form" action="Php/SubmitNewCon.php" method="post" target="myIframeSubNewCon">
    ...
    <iframe id="myIframe" name="myIframeSubNewCon" style="display:none"></iframe>
    </div>
    </div>
</div>
    <?php
