            ...
            <table class="table table-striped table-hover">
                ...
                ?>
                    <tr>
                        <td> <?php echo $i + 1?> </td>
                        <td>
                            <a href=<?php echo '"/OtherUser.php?User='. $AllUserData["$i"]['Name']. '"'?> class= <?php echo GetUserColor($AllUserData[$i]['Fight']) ?>> <?php echo $AllUserData[$i]['Name']?> </a>
                        </td>
